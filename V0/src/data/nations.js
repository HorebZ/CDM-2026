// ============================================================
// LISTE DES 48 NATIONS QUALIFIÉES — CDM 2026
// Pour activer les couleurs d'un drapeau : enabled: true
// ============================================================

export const NATIONS = [
  // CONCACAF (6)
  { code: 'us',     name: 'États-Unis',       enabled: true },
  { code: 'ca',     name: 'Canada',           enabled: true },
  { code: 'mx',     name: 'Mexique',          enabled: true },
  { code: 'pa',     name: 'Panama',           enabled: true },
  { code: 'ht',     name: 'Haïti',            enabled: true },
  { code: 'cw',     name: 'Curaçao',          enabled: true },

  // CONMEBOL (6)
  { code: 'ar',     name: 'Argentine',        enabled: true },
  { code: 'br',     name: 'Brésil',           enabled: true },
