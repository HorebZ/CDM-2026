...
<section
	class="flex w-full items-center justify-center max-[800px]:w-[min(100%,calc(var(--flag-size)*6+var(--flag-gap)*5))] max-[560px]:w-[min(100%,calc(var(--flag-size)*5+var(--flag-gap)*4))] max-[420px]:w-[min(100%,calc(var(--flag-size)*4+var(--flag-gap)*3))]"
>
	<div
	...
	>
		<div
			class="flex h-[104px] w-[78px] select-none items-center justify-center leading-none transition-[filter] duration-400 max-[420px]:h-[78px] max-[420px]:w-[58px]"
